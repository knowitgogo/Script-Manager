...
@section('title', __('messages.admin_register') ?? 'Admin Register')
...
<div class="container">
        <div class="card">
            <h1>{{ __('messages.admin_register') ?? 'Admin Register' }}</h1>
            ...
            <form method="POST" action="{{ route('admin.register.post') }}">
                ...
                <button class="button" type="submit">{{ __('messages.register') ?? 'Register' }}</button>
            </form>
        </div>
    </div>
