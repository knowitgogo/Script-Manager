        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('admin.managers.update', $manager) }}">
                ...
                <div class="field">
                    ...
                    <input class="input" id="name" name="name" type="text" value="{{ old('name', $manager->name) }}" required autocomplete="name" />
                </div>

                <div class="field">
                    <label class="label" for="email">Email</label>
                    <input class="input" id="email" name="email" type="email" value="{{ old('email', $manager->email) }}" required autocomplete="email" />
                </div>
                ...
                <div style="display:flex; gap: 12px; flex-wrap: wrap; align-items: center;">
                    ...
                    <a href="{{ route('admin.managers.index') }}" class="button secondary">Back to List</a>
                </div>
            </form>
        </div>
    </div>
