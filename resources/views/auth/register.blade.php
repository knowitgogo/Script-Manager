...
<div class="container">
        ...
        <p class="helper" style="margin-top:16px; font-size:14px; color:#475569;">Already have an account? <a href="{{ route('login') }}" style="color:#2563eb; text-decoration:none;">Login here</a>.</p>
    </div>
